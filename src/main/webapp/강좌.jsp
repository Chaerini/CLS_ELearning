...
<br>
			...
			<tr>
			<td width=400 onclick="location.href='c언어 기초.jsp'"><h2>C언어 기초</h2></td>
			</tr>
			
			<tr>
			<td onclick="location.href='기타입문.jsp'"><h2>기타 입문</h2></td>
			</tr>
			
			<tr>
			<td onclick="location.href='일본어 입문.jsp'"><h2>일본어 입문</h2></td>
			</tr>
			
			<tr>
			<td  onclick="location.href='생활체육.jsp'"><h2>생활체육</h2></td>
			</tr>
			</table>
