...
<div class="hello">안녕하세요 <jsp:getProperty name="obj" property="userid"/> 님!<br></div>
<hr class="hr">
</header>
...
<br>
<br>
<h2>c언어 기초 1강 - 문법 기초</h2><hr><br><br><br>
<video src="media/c언어 기초 1강.MP4" width="750" height="400" autoplay controls>
